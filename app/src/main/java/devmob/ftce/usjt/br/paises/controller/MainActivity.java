...
public class MainActivity extends Activity {
    ...
    public static final String CHAVE = "devmob.ftce.usjt.br.paises.txtContinente";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinnerContinente.setOnItemSelectedListener(new PaisSelect());
    }
    ...
    private class PaisSelect implements AdapterView.OnItemSelectedListener {
